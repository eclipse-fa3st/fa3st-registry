...
public class SubmodelRegistryControllerIT {
    ...
    private SubmodelDescriptor getSubmodel() {
        return new DefaultSubmodelDescriptor.Builder()
                .id("http://example.org/IntegrationTest/Submodel200")
                ...
                .semanticId(new DefaultReference.Builder()
                        ...
                        .keys(new DefaultKey.Builder()
                                ...
                                .value("http://example.org/IntegrationTest/Submodel200/SemanticId")
                                .build())
                        .build())
                .endpoints(new DefaultEndpoint.Builder()
                        ...
                        .protocolInformation(new DefaultProtocolInformation.Builder()
                                ...
                                .href("http://example.org/Endpoints/Submodel200")
    ...
    private SubmodelDescriptor getSubmodelUpdate() {
        return new DefaultSubmodelDescriptor.Builder()
                .id("http://example.org/IntegrationTest/Submodel201")
                ...
                .semanticId(new DefaultReference.Builder()
                        ...
                        .keys(new DefaultKey.Builder()
                                .type(KeyTypes.GLOBAL_REFERENCE)
                                .value("http://example.org/IntegrationTest/Submodel201/SemanticId")
                                .build())
                        .build())
                .endpoints(new DefaultEndpoint.Builder()
                        ._interface("http")
                        .protocolInformation(new DefaultProtocolInformation.Builder()
                                .endpointProtocol("http")
                                .href("http://example.org/Endpoints/Submodel201")
